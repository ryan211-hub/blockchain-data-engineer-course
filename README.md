...
- Module 7 已完成：第 1 课、第 2 课、第 3 课、第 4 课、第 5 课、第 6 课、第 7 课、第 8 课、第 9 课
- 当前 Lesson：Module 7 第 9 课｜Mini Indexer 实践：用 Python + Ethereum JSON-RPC 实现最小 ERC-20 Transfer Indexer
- 当前状态：✅ 已完成
- 最近完成：Module 7 第 9 课理解检查与校准完成；已把 Fetcher / Parser / Decoder / Normalizer / Idempotent Writer / Checkpoint 映射到 Python + Ethereum JSON-RPC + SQLite 的最小实现，并理解 Event Signature、Stable Identity、Unique Constraint、Crash Recovery 与 Write Data → Save Checkpoint 的正确性要求。
- 尚未完成：Module 7 第 10 课
- 下一步准确入口：开始 Module 7 第 10 课｜Mini Indexer 可靠性实践：Crash Recovery / Backfill / Reorg Recovery。重点在第 9 课最小 Processing Engine 上实现独立 Backfill Cursor、Reorg Detection / Common Ancestor / Rollback + Replay，并验证 Realtime / Backfill / Reorg Replay 复用同一 Processing Engine。
