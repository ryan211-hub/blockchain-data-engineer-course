...
- 当前状态：第 6 课理解检查中
- 最近完成：Module 8 第 5 课《Raw / Normalized Fact / DWS / ADS：数据职责边界》三道理解检查全部通过并正式结束；第 6 课 Canonical Base 已同步到 Notion 与 GitHub。
- 尚未完成：Module 8 第 6 课理解检查与必要校准；第 4 课 GitHub Lesson 的问题 3 与结课段落待同步；第 5 课 Notion Lesson 存在 Q2 顺序 / 重复 Canonical Drift 待修复，GitHub Lesson 的问题 2、问题 3与结课段落待同步
