...
- 完成结论：已达到 Module Contract 结束标准，能够解释 RPC 请求路径、RPC Interface 与 Provider 的区别、不同 RPC 成本，以及 Provider 的基础设施与商业价值。
- 下一步准确入口：Module 6 — Archive Node，第 1 课｜Archive Node 到底多保存了什么：History ≠ Historical State。
...
7. [第7课｜RPC Provider 到底卖什么：成本、计费与为什么公司愿意付费](lesson-07-rpc-provider-cost-pricing-business.md)