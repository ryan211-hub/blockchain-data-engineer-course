...
- 已完成 Lesson：第 1 课｜为什么链上数据也需要数据建模：从 Indexer Fact 到可分析模型；第 2 课｜Grain：为什么“一行代表什么”是数据建模的第一原则；第 3 课｜Fact 与 Dimension：哪些数据是事实，哪些数据是维度
- 当前 Lesson：第 4 课｜Source Identity 与 Business Identity
- 当前状态：待开始
- 已完成 Module：Module 1～7
- 下一步准确入口：开始 Module 8 第 4 课｜Source Identity 与 Business Identity。
