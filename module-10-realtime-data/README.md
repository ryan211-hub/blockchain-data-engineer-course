...
- 已完成 Lesson：第 1 课｜实时数据到底是什么：为什么不是“把 ETL 跑快一点”；第 2 课｜Kafka 在实时 Pipeline 中到底解决什么问题；第 3 课｜Topic、Partition、Offset：数据流如何被切分和定位
- 当前 Lesson：第 4 课｜Consumer Group 与 Ordering：如何同时获得并行处理和局部有序
